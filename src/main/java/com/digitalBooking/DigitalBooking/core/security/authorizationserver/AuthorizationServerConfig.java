...
//		security.checkTokenAccess("isAuthenticated()");
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) throws Exception {
        ...
        enhanceChain.setTokenEnhancers(Arrays.asList(new JwtCustomClaimsTokenEnhancer(),
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        //jwtAccessTokenConverter.setSigningKey("digitalBookingdncdnadwskcndscdskcbiwj33243c");

        var keyStorePass = jwtKeyStoreProperties.getPassword();
        var keyPairAlias = jwtKeyStoreProperties.getKeyPairAlias();

        var keyStoreFactory = new KeyStoreKeyFactory(
